...
namespace backend.Migrations
{
    ...
    [Migration("20240529210459_deleteTotalGameTime")]
    partial class deleteTotalGameTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Data.PlayerIdentity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("backend.Data.entities.DbGameResultMatch", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("backend.Data.PlayerIdentity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Data.entities.DbGameResultMatch", b =>
                {
                    b.HasOne("backend.Data.entities.DbPlayerInfo", "Player1")
                        .WithMany()
                        .HasForeignKey("Player1Id");

                    b.HasOne("backend.Data.entities.DbPlayerInfo", "Player2")
                        .WithMany()
