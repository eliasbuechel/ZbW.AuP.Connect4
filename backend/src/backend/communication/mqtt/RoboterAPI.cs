...
namespace backend.communication.mqtt
{
    internal abstract class RoboterApi : DisposingObject
    {
        ...
        private const int TESTING_REQUEST_TIMOUT_TIME_IN_MS = 3000; // 3s
        private const int ROBOTER_MOVE_REQUEST_TIMOUT_TIME_IN_MS = 3000000; // 30s
        private const int ROBOTER_RESET_REQUEST_TIMOUT_TIME_IN_MS = 6000000; // 60s
    }
}