<template>
  <div class="home-view-container">
    <LoadingScreenVue v-if="identity == null || bestlist == null" />
    <GameResultView
    ...
    />
    <GameVue
      v-else-if="game != null && isVisualizingOnRoboter != null"
      :game="game"
      :identity="identity"
    ...
    />
    <MainBoardVue
      v-else-if="bestlist != null && isVisualizingOnRoboter != null"
      :identity="identity"
      :bestlist="bestlist"
...
export default defineComponent({
  ...
  data(): HomeState {
    return {
      ...
      isSubscribed: false,
      isVisualizingOnRoboter: undefined,
    };
  },
  components: {
    LoadingScreenVue,
  ...
  methods: {
    subscribe(): void {
      ...
      signalRHub.on("SendVisualisationState", this.onSendVisualisationState);
    },
    unsubscribe(): void {
      if (!this.isSubscribed) return;
      ...
      signalRHub.off("SendVisualisationState", this.onSendVisualisationState);
    },
    ...
    visualizingOnRoboterChanged(isVisualizingOnRoboter: boolean): void {
      signalRHub.invoke("VisualizeOnRoboterChanged", isVisualizingOnRoboter);
      this.isVisualizingOnRoboter = isVisualizingOnRoboter;
    },
    ...
    onSendVisualisationState(visualisationState: boolean): void {
      this.isVisualizingOnRoboter = visualisationState;
    },
    onSignalRConnected(): void {
      ...
      signalRHub.invoke("GetVisualisationState");
    },
